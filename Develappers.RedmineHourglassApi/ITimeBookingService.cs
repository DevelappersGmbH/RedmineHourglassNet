...
public interface ITimeBookingService
{
    ...
    Task<TimeBooking> GetAsync(int id, CancellationToken token = default);
    ...
    /// <param name="token">The cancellation token.</param>
    /// <returns></returns>
    Task UpdateAsync(int id, TimeBookingUpdate values, CancellationToken token = default);
    ...
    /// <param name="token">The cancellation token.</param>
    /// <returns></returns>
    Task BulkUpdateAsync(List<TimeBookingBulkUpdate> values, CancellationToken token = default);
    ...
    /// <param name="token">The cancellation token.</param>
    /// <returns></returns>
    Task BulkCreateAsync(List<TimeBookingBulkCreate> values, CancellationToken token = default);
}